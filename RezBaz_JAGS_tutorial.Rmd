...
# (Example From Ecological Forecasting Dietze, inspired by XKCD):
https://xkcd.com/1132/
...
You can test out a few different priors  to see how our prior belief that the sun has actullay exploded affects our posterior estimates. 
```{r}
...
posterior = (likelihood.theta1*prior_theta1)/((likelihood.theta1*prior_theta1)+(likelihood.theta2*prior_theta2))
