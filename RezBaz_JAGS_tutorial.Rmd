...
Where $P(B|A)$ is the likelihood function
...
# What is the:
1. Marginal probability of being in group A = (5/12)
2. Marginal probability of being in group B = (9/12)
3. Joint probability of being in A and B = (2/12)
4. Conditional probability that we are in A, given that we are in B? 2/9
5. Conditional probaiblity that we are in B, given that we are in A? 2/5
...
Example From Ecological Forecasting Dietze, inspired by comic below XKCDhttps://xkcd.com/1132/:
...
prior_theta1 = 1/10000 # prior belief that the sun has gone nova
...
#### In your groups, discuss:
  ...
  3. what aspects of uncertainty do the bayesian predictive intervals include?
